...
void ImageFilter8(double *fliter, int windowWidth, unsigned short *pixels, int w, int h, int stride)   //��buffer���и�˹ƽ���˲�
{
	int i;
	...
	for (y = _top + hw; y < _bottom - hw; y++)   //ͼ����������
...
BOOL MUSICA_ImageSubsample(unsigned short *X, int X_w, int X_h, int X_stride, unsigned short *X_1, int X_1_w, int X_1_h, int X_1_stride)   //buffer���г����õ���һ���Ľ���ͼX+1
{
...
BOOL MUSICA_ImageInterpolator(unsigned short *X_1, int X_1_w, int X_1_h, int X_1_stride, unsigned short *X, int X_w, int X_h, int X_stride)   //����ͼX+1���в�ֵ0��buffer
{
	if (2 * (X_1_w - 1) > X_w - 1 || 2 * (X_1_h - 1) > X_h - 1)
	{
		return FALSE;
...
void MUSICA_ImageSub8(unsigned short *pMinuend, unsigned short *pSubtrahend, unsigned short *pResult, int w, int h, int stride)   //X��ȥƽ������buffer�õ��в�ͼ�񱣴���X
{
	int pixelByte8 = 1;   /////////////////////////////////
...
BOOL MUSICA_Decomposition(unsigned short *pPixelsGrey, unsigned short *pDecomposition, int *matrixInfo)
{
	//1) ��X����һ���ֽ⣬X������buffer
	//2) ��buffer����ƽ���˲�
	//3) buffer���г����õ���һ���Ľ���ͼX+1
	//4) ����ͼX+1���в�ֵ0��buffer
	//5) �����˲�������4������0���еĲ�������ƽ���˲�
	//6) X��ȥƽ������buffer�õ��в�ͼ�񱣴���X
	...
	//��Դ�ڴ���ַ����ʼλ�ÿ�ʼ�������ɸ��ֽڵ�Ŀ���ڴ���ַ�У�����Դsource�п���n���ֽڵ�Ŀ��destin��
...
void MUSICA_ImageAdd8(unsigned short *pOriginal, unsigned short *pDetail, unsigned short *pResult, int w, int h, int stride)    //ԭʼͼ��+ϸ��
{
...
BOOL MUSICA_Reconstruction(unsigned short *pPixelsGrey, unsigned short *pDecomposition, int *matrixInfo)   //�ع�ͼ��
{
	int i;
	int nLevel = *matrixInfo;
	if (nLevel < 2)
...
//	int* pnMatrixInfo = new int[1+nLevel*3];
	...
	//�ֽ�
	MUSICA_Decomposition(pPixelsGrey, pDecomposition, pnMatrixInfo);     //�������ֽ�

	//�任
	MUSICA_Mapping(pDecomposition, pnMatrixInfo, dPower);

	//�ع�
	MUSICA_Reconstruction(pPixelsGrey, pDecomposition, pnMatrixInfo);    //�������ع�
